...
public class MessageConstant {
    ...
    public static final String ADD_CHECKITEM_SUCCESS = "the new operation succeeded";
    public static final String ADD_CHECKITEM_FAIL = "sorry,the add operation failed";
    ...
    public static final String VALIDATECODE_ERROR = "验证码无效";
    ...
    public static final String ORDER_FULL = "预约已满，尝试更换日期";
    public static final String HAS_ORDERED = "已经预约当天体检，不能重复预约";
